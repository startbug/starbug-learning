package com.example.starbugorder;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws IOException {
        File file = new File("./starbug-alibaba/starbug-order");
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/starbug_order?serverTimezone=GMT%2B8&characterEncoding=UTF-8", "root", "123456")
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("order_item", "orders"); // 设置需要生成的表名
                })
